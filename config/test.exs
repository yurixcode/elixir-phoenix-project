...
config :ex_mon, ExMonWeb.Endpoint,
  ...
  secret_key_base: "YazClknkruWfUgw9mth65hxksCU9qeftuTfoMtPyYiPZ9Nn+R8QUXq04+UdgKBdz",
  server: false
...
config :ex_mon, ExMonWeb.Auth.Guardian,
  issuer: "ex_mon",
  secret_key: "ZQkUnTgV3NeTS+103ntCMiAM6Yx7E21b7nOGE4Wcf6irECDt0uFVw2Mkv1632tYD"
